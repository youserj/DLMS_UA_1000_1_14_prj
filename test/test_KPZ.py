...
from src.DLMS1.cosem_interface_classes.implementations import data
...
from src.DLMS1.cosem_interface_classes.association_ln import client_sap
from src.DLMS1.cosem_interface_classes.association_ln.ver0 import ClientSAP
...
class TestType(unittest.TestCase):
    ...
    def create_collection(self) -> collection.Collection:
        ...
        reg = col.add(
            ...
            logical_name=octet_string.LN("01 00 01 07 00 ff")
        )
        col.add(
    ...
    def test_get_tree(self):
        from src.DLMS1.obis.media_id import MediaId
        col = collection.get_collection(
            manufacturer=b"KPZ",
            server_type=collection.ParameterValue(
                par=bytes.fromhex("0000600102ff02"),
