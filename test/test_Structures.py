...
from src.DLMS1.types.common_data_types import encode_length
...
class TestType(unittest.TestCase):
    ...
    def test_WeekProfile(self):
        from src.DLMS1.cosem_interface_classes.activity_calendar import WeekProfile
