...
from src.DLMS1.types.common_data_types import encode_length, ValidationError, OutOfRange
from src.DLMS1.cosem_interface_classes import ic, collection
from src.DLMS1.types import cdt, cst, ut, implementations as impl, choices
from src.DLMS1 import relation_to_OBIS, enums
from src.DLMS1.cosem_interface_classes.collection import Collection
from src.DLMS1.cosem_interface_classes.arbitrator import WeightingsTable
...
class TestType(unittest.TestCase):
    ...
    def test_ProfileGeneric(self):
        from src.DLMS1.cosem_interface_classes.association_ln.ver1 import ObjectListElement
        from src.DLMS1.types.implementations import structs
        col = Collection()
    ...
    def test_RestrictionElement(self):
        from src.DLMS1.cosem_interface_classes.push_setup.ver2 import RestrictionElement
    ...
    def test_all_cdt(self):
        from src.DLMS1.cosem_interface_classes.gprs_modem_setup import QualityOfService
    ...
    def test_ConfPar(self):
        from src.DLMS1.cosem_interface_classes.push_setup.ver2 import ConfirmationParameters
